...
#define SOLVER_DATA_NORM_EUCLIDEAN                                             \
    (2 | SOLVER_DATA_TYPE_EUCLIDEAN | SOLVER_DATA_TYPE_2D)
#define SOLVER_DATA_NORM_EUCLIDEAN_3D                                          \
    (3 | SOLVER_DATA_TYPE_HILBERT | /* k-dtree not implemented for 3d */       \
     SOLVER_DATA_TYPE_3D)
#define SOLVER_DATA_NORM_ATT                                                   \
    (4 | SOLVER_DATA_TYPE_HILBERT | SOLVER_DATA_TYPE_2D)
#define SOLVER_DATA_NORM_GEOGRAPHIC                                            \
    (5 | SOLVER_DATA_TYPE_HILBERT | SOLVER_DATA_TYPE_2D)
#define SOLVER_DATA_NORM_GEOM                                                  \
    (6 | SOLVER_DATA_TYPE_HILBERT | SOLVER_DATA_TYPE_2D)
